...
export const googlrProvider = new firebase.auth.GoogleAuthProvider();
googlrProvider.setCustomParameters({ prompt: "select_account" });
export const signInWithGoogle = () => auth.signInWithPopup(googlrProvider);
